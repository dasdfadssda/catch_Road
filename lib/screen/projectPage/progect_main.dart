              ...
              builder: (context, snapshot) {
                ...
                return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (part == true &&
                          (snapshot.data!.docs[index]['part_user'].contains(
                                        ...
                                        Container(
                                          ...
                                          child: ClipRRect(
                                            ...
                                            child: LinearProgressIndicator(
                                              ...
                                              //  style: ddaycalc(snapshot.data!.docs[index]['final_day2'])<0?titleMediumStyle(color:Colors.grey):titleMediumStyle(),
                                            ),
                                          ),
                                        ),
                                        Padding(
                            ...
                            child: InkWell(
                              onTap: () {
                                ...
                                if (snapshot.data!.docs[index]['part_user']
                                  ...
                                  if (ddaycalc((snapshot.data!.docs[index]['final_day2'])) >= 0) {
                                    Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                          builder: (BuildContext context) =>
                                  ...
                                  children: [
                                    Padding(
                                      padding: EdgeInsets.only(
                                          ...
                                          left: size.width * 0.045),
                                      child: Text(
                                        ddaycalc(snapshot.data!.docs[index]['final_day2']) > 0
                                            ? "D- ${ddaycalc(snapshot.data!.docs[index]['final_day2'])}"
                                            : ddaycalc(snapshot.data!.docs[index]['final_day2']) == 0
...
int ddaycalc(Timestamp final_date) {
  return final_date.toDate().difference(DateTime.now()).inDays;
}
