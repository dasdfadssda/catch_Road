...
class _HomePageState extends State<communityPage> {
 ...
 int _Likes = 0;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      title:TextButton(
        child:  Text('양덕동 외 1곳',style: titleStyle()), // provider로 설정해야함.. 나중에 
        onPressed: (){
        },
      ),
      actions: [
            ...
            child: Column(
              ...
              children: [
                ...
                Row(                                 // 질문 부분
                    children: [
                        Text(
                          'Q.',style: bodyMlStyle(color: Color(0XFF3174CD)),
                        ),
                        Text(
                           snapshot.data!.docs[index]['contents'],style: bodyMlStyle(color: Color(0xFF1A1A1A)),
                        ),
                    ],
                ),
                ...
                SizedBox(
                    ...
                    child: Row(
                        children: [
                          ...
                          SizedBox(width: 4,),
                          Text(snapshot.data!.docs[index]['like'].toString(),style: LabelsmallStyle(color: Color(0XFF9FA5B2)),),
                          SizedBox(width: 17,),
                         IconButton(
                            color: Color(0XFF878E9F),
                            constraints: BoxConstraints(maxHeight: 15),
  ...
  PreferredSizeWidget buildAppBarBottom() { // 바텀바 부분 
    return PreferredSize(
      ...
      child:Container(
        height: 30,
        margin: EdgeInsets.fromLTRB(37, 0, 25,20),
          child :  Row(
    ...
    return Container(
      ...
      alignment: Alignment.center,
           ...
           style: ElevatedButton.styleFrom(
             ...
             elevation: 0,
            textStyle: TextStyle(fontWeight: FontWeight.w500,fontSize: 9),
