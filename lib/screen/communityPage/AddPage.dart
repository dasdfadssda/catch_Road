...
import '../../Style/Widget/Widget.dart';
...
var _scaffoldKey = new GlobalKey<ScaffoldState>();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      title: Text('질문하고 싶어요',style: titleStyle()),
      actions: [
        TextButton(
              onPressed: () async{
  ...
  bool _catagorySet = false;
    ...
    return ListTile(
      contentPadding: EdgeInsets.only(top: 42,left: 24,right: 32),
      onTap: (() => _showcategoryicker(context)),
      leading: Container(
        padding: EdgeInsets.only(top: 2.5),
        child: Text('카테고리 설정하기',style: BodyStyle()),
      ),
    ...
    return Container(
      ...
      padding: _road ? EdgeInsets.fromLTRB(14, 7.5, 14, 7) : EdgeInsets.fromLTRB(15, 7.5, 15, 7),
      height: 30,
      child: _road ? Text('도로 위가 궁금해요',style:  LabelStyle(color: Colors.white)) : Text('캐치가 궁금해요',style: LabelStyle(color: Colors.white), textAlign: TextAlign.center,),
   ...
   void _showcategoryicker(context) { // 카테고리 설정 스냅바
    showModalBottomSheet(
      ...
      child: Text('카테고리 설정하기',style: LabelStyle())
      ),
        Container(
            ...
            children: [
              TextButton(
                onPressed: (){
                  ...
                  child: Text('취소',style: buttonStyle(color: Color(0XFF9FA5B2))),),
                  SizedBox(width: 194),
                  TextButton(
                onPressed: (){
                  setState(() {
                  ...
                  child: Text('확인',style: buttonStyle(color: Color(0XFF3A94EE))),),
            ],
          ),
        )
                        ],
  ...
  final firebaseStorageRef = FirebaseStorage.instance; 
   ...
   Widget ShowTakePicture() { // 사진 가져오기 스냅바 + 화면 
    if(_selectedFileList!.length == 0) {
      ...
      leading: Text('예시 사진 추가',style: BodyStyle()),
      trailing:  Icon(Icons.arrow_forward_ios,color: Color(0XFFCFD2D9),),
    );
    } else return
     Container(
  ...
  double _longitude = 0.0; //경도
   ...
   Widget Addlocation() { // 위치 가져오기 
    if(postCode == '-') {
      ...
      leading: Text('도로 위치 추가 ',style: BodyStyle()),
      trailing:  Icon(Icons.arrow_forward_ios,color: Color(0XFFCFD2D9),),
    );
    } else {
      return Container(
        ...
        Container(
          child: Row(children: [
            ...
            Container(
              ...
              child: Text('${roadAddress}',style: LabelStyle(),),
            )
          ],),
        height: 60, 
                    ...
                    return Container(
                      ...
                      child: Column(children: [
                        Container(
                          ...
                          child: Text("작성 중인 질문을 하지 않으시겠습니까?\n       진행상황은 저장되지 않습니다.",style: normalStyle(),),
                        ),
                        Container(
                    ...
                    return Container(
                      ...
                      child: Column(children: [
                        ...
                        Container(
                          ...
                          child: Text("질문이 업로드 되었습니다.",style: normalStyle(),),
                        ),
                        Container(
                          height: 40,
                          width: 312,
                         decoration: BoxDecoration(
                          ...
                          child:  TextButton(
                                  onPressed: (){
                                    ...
                                    child: Text('확인',style: buttonStyle(color: Colors.white)))
                        )
                      ]),
                    );
                    }
