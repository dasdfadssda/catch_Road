...
class _DetailScreenState extends State<DetailScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    MaterialPageRoute(builder: (context) => communityPage()),
        ...
        title: Text('커뮤니티',style: titleStyle(),),
      ),
            ...
            return  Container(
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      Text(snapshot.data!.docs[_Index]['contents'],style: bodyMlStyle(color: Color(0xFF1A1A1A))),
                      SizedBox(height: 20),
                      Center(                                         // 디바이더 위젯
                        child: SizedBox(
                            width: 350,
                 ...
                 builder: (context, snapshot) {
                    if(snapshot.data!.docs[_Index]['_comment'].length == 0) {
                           return  Container(
                             ...
                             child: Align(
                               child:  Text('   아직 댓글이 없어요 :(\n가장 먼저 댓글을 남겨보세요',style: LabelStyle(color: Color(0XFF9FA5B2))),
  ...
  //        ClipRRect(
  //        borderRadius: BorderRadius.circular(7.0),
  //       child: Image.network(imageList[0].toString(),fit :BoxFit.fill,height: 170,width: 171,)),
  //        SizedBox(width: 10),
  //       Stack(children: [
  //          ClipRRect(
  //        borderRadius: BorderRadius.circular(7.0),
  //       child: Image.network(imageList[1].toString(),fit :BoxFit.fill,height: 170,width: 171,)),
  //       Container(
  //          alignment: Alignment.center,
  //        decoration: BoxDecoration(
  //        borderRadius: BorderRadius.circular(7.0),
