                                                        ...
                                                        TextButton(
                                                            ...
                                                            onPressed: (){
                                                              ...
                                                              setState(() {
                                                                ...
                                                                _range1 = '';
                                                                //_range2 = '';
                                                                _dataPickerController.selectedRanges = null;
                                                              });
                                                            },
                                            ...
                                            child: Column(
                                              children: [
                                                StreamBuilder<QuerySnapshot>(
                                                    stream: FirebaseFirestore.instance.collection('category').doc(FirebaseAuth.instance.currentUser!.email).collection(query['category']).doc('place').collection('place').snapshots(),
                                                                    ...
                                                                    InkWell(
                                                                      ...
                                                                      onTap: (){
                                                                        if(x['choose']){
                                                                          print(x['choose']);
                                                                          setState(() {
                                                                            place_list.removeWhere((item) => item == x['place']);
                                                                          });
                                                                          FirebaseFirestore.instance.collection('category').doc(FirebaseAuth.instance.currentUser!.email).collection(query['category']).doc('place').collection('place').doc(x['place']).update({
                                                                            'choose': false
                                                                          });
                                                                        }
                                                                        else{
                                                                          setState(() {
                                                                            place_list.add(x['place']);
                                                                          });
                                                                          FirebaseFirestore.instance.collection('category').doc(FirebaseAuth.instance.currentUser!.email).collection(query['category']).doc('place').collection('place').doc(x['place']).update({
                                                                            'choose': true
                                                                          });
                              ...
                              child: Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Icon(_selectPlaceIcon? Icons.keyboard_arrow_down_outlined : Icons.clear_outlined, color: _selectPlaceTextColor),
                                    ],
                                  )
                              ),
                            ),
                            ...
                            InkWell(
                              child: Container(
                                  ...
                                  child: Row(
                                    mainAxisAlignment: MainAxisAlignment.center,
                                    children: [
                                      Text('미디어 형식', style: TextStyle(color : Color(0xFF9FA5B2))),
                                      Icon(Icons.keyboard_arrow_down_outlined, color: Color(0xFF9FA5B2))
                                    ],
                                  )
                              ),
                            ),
