...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget _catagorySetWidget() {
    ...
    return Container(
      ...
      child: _road
          ? Text('도로 위가 궁금해요',
              style: labelMediumStyle(color: Colors.white),
  ...
  void _showcategoryicker(context) {
    // 카테고리 설정 스냅바
                    ...
                    Container(
                      ...
                      child: ElevatedButton(
                          style: ElevatedButton.styleFrom(
                            ...
                            onPrimary:
                                _catch ? Colors.white : Color(0XFF9FA5B2),
                          ),
                          onPressed: () {
                            bottomState(() {
                              setState(() {
                  ...
                  child: Row(
                    children: [
                      ...
                      TextButton(
                        ...
                        child: Text('확인',
                            style: labelSmallStyle(color: Color(0XFF3A94EE))),
                      ),
                    ],
                  ),
                )
  ...
  Future<List> uploadFile(XFile _image) async {
    // 사진 url 업로드 하기
                      ...
                      child: Stack(children: [
                        Container(
                            ...
                            child: ClipRRect(
                              ...
                              child: Image.file(
                                  File(_selectedFileList![index].path),
                                  fit: BoxFit.fill),
                            )),
                        Align(
  ...
  void _showcategoryCancel(context) {
    // 나가기 관련 스냅바
    showModalBottomSheet(
        context: context,
        shape: const RoundedRectangleBorder(
  ...
  void _showcategoryUPload(context) {
    // 업로드 관련 스냅바
    showModalBottomSheet(
        context: context,
        shape: const RoundedRectangleBorder(
